...
# 28.Python script to print index of all occurrence of given element in a given list

l=[]
n=int(input("insert the size of list : "))
for i in range(n):
    l.append(int(input("insert the element : " )))
print(l)
n=int(input("enter the number you want to know their index number : "))
print(n, "comes at index number : ", end="")
